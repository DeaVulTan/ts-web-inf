							...
							<div class="gn-scroller">
								<ul class="gn-menu">
									<li>
										...
										<ul class="gn-submenu">
											<li><a class="gn-icon gn-icon-dashboard profilDashboard" onClick="profilDashboardInit();">Главная</a></li>
									...
									<li class="webinterfacearea">
										...
										<ul class="gn-submenu">
											<li><a class="gn-icon gn-icon-server teamspeakServer" onClick="teamspeakServerInit();">Сервер</a></li>
									...
									<li>
										<a class="gn-icon gn-icon-ticket" style="cursor:default !important;">Система тикетов</a>
										<ul class="gn-submenu">
											<li><a class="gn-icon gn-icon-ticket ticketMain" onClick="ticketInit();">Тикеты</a></li>
										</ul>
									</li>
								</ul>
							</div>
							...
							<div class="gn-scroller">
								<ul class="gn-menu">
									<li>
										...
										<ul class="gn-submenu">
											<li><a class="gn-icon gn-icon-arrow-left" onClick="profilDashboardInit();"><?php echo $language['back']; ?></a></li>
										</ul>
									</li>
									<?php if(strpos($user_right['ports']['right_web_server_start_stop'][$serverInstanz], $server['data']['virtualserver_port']) !== false || $user_right['right_web_global_server'] == $mysql_keys['right_web_global_server']) { ?>
										<li>
											<a class="gn-icon gn-icon-server" style="cursor:default !important;">Сервер</a>
											<ul class="gn-submenu">
...
<nav class="navbar navbar-copyright navbar-fixed-bottom">
	<div id="copyright" class="col-xs-12 col-md-12">
		<i class="fa fa-copyright"></i> by <a href="">First-Coder.de</a> || written by <strong>L. Gmann</strong>
	</div>
</nav>
