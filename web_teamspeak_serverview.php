			...
			<div class="card-block">
				<div class="form-group">
					<?php
						...
						$iframeText		=	"<iframe allowtransparency=\"true\" src=\"".$iframeLink."?port=".$server['data']['virtualserver_port']."&instanz=".$serverInstanz."&color=666&bodybgcolor=fff&spinbgcolor=fff&fontsize=1em\" style=\"height:100%;width:100%\" scrolling=\"auto\" frameborder=\"0\">Твой браузер будет показывать пользователей</iframe>";
					?>
